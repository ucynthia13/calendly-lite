...
export default function Hero() {
  return (
    <div className="w-full flex flex-row items-center justify-between px-8 bg-card mt-12">
      <div className="flex flex-col max-w-md space-y-6">
        ...
        <div className="flex flex-col md:flex-row gap-4 md:gap-2 justify-center">
