CREATE TYPE "public"."enum" AS ENUM('monday', 'tuesday', 'wednesday', 'thurday', 'friday', 'saturday', 'sunday');--> statement-breakpoint
CREATE TABLE "events" (
...
CREATE TABLE "schedule" (
	...
	"createdAt" timestamp DEFAULT now() NOT NULL,
	"updatedAt" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "schedule_clerkUserId_unique" UNIQUE("clerkUserId")
);
--> statement-breakpoint
